...
test.describe('online-auction Smoke Tests', () => {
  ...
  test('03 create loads correctly', async ({ page }) => {
    await login(page);
  ...
  test('04 my auctions loads correctly', async ({ page }) => {
    await login(page);
  ...
  test('05 watchlist loads correctly', async ({ page }) => {
    await login(page);
