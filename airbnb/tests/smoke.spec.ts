...
async function login(page: Page) {
  ...
  await page.locator("input[name='email'], input[type='email']").first().fill('guest1@example.com');
...
test.describe('airbnb Smoke Tests', () => {
  ...
  test('04 become host loads correctly', async ({ page }) => {
    await login(page);
  ...
  test('05 messages loads correctly', async ({ page }) => {
    await login(page);
