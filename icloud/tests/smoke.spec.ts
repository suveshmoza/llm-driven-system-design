...
test.describe('icloud Smoke Tests', () => {
  ...
  test('02 drive loads correctly', async ({ page }) => {
    await login(page);
  ...
  test('03 photos loads correctly', async ({ page }) => {
    await login(page);
  ...
  test('04 admin loads correctly', async ({ page }) => {
    await login(page);
