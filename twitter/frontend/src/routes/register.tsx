    ...
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="w-full max-w-[400px] p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-[31px] font-bold mt-6 text-twitter-dark">Create your account</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <input
              ...
              className="w-full px-4 py-3 border border-twitter-border rounded-md focus:outline-none focus:border-twitter-blue focus:ring-1 focus:ring-twitter-blue text-[17px] text-twitter-dark placeholder-twitter-gray"
            />
            <p className="text-[13px] text-twitter-gray mt-1">Must be at least 6 characters</p>
          </div>

          <button
            type="submit"
            disabled={!username.trim() || !email.trim() || !password || password.length < 6 || isSubmitting}
            className="w-full py-3 bg-twitter-blue text-white rounded-full font-bold text-[17px] hover:bg-twitter-blueHover disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
        ...
        <div className="mt-10 text-center">
          <span className="text-twitter-gray text-[15px]">Already have an account? </span>
          <Link to="/login" className="text-twitter-blue text-[15px] hover:underline">
            Sign in
          </Link>
        </div>
      </div>
