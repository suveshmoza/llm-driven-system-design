...
test.describe('venmo Smoke Tests', () => {
  ...
  test('03 pay loads correctly', async ({ page }) => {
    await login(page);
    await page.goto('/pay');
    await page.waitForTimeout(500);
  ...
  test('04 request loads correctly', async ({ page }) => {
    await login(page);
  ...
  test('05 wallet loads correctly', async ({ page }) => {
    await login(page);
