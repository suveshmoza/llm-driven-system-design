...
test.describe('retool Smoke Tests', () => {
  ...
  test('04 app editor loads correctly', async ({ page }) => {
    await login(page);
    await page.goto('/app/e1111111-1111-1111-1111-111111111111/edit');
  ...
  test('05 app preview loads correctly', async ({ page }) => {
    await login(page);
    await page.goto('/app/e1111111-1111-1111-1111-111111111111/preview');
    await page.waitForTimeout(1500);
