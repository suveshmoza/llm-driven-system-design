...
test.describe('tiktok Smoke Tests', () => {
  ...
  test('03 discover loads correctly', async ({ page }) => {
    await login(page);
  ...
  test('04 inbox loads correctly', async ({ page }) => {
    await login(page);
  ...
  test('05 upload loads correctly', async ({ page }) => {
    await login(page);
