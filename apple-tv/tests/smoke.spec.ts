...
test.describe('apple-tv Smoke Tests', () => {
  ...
  test('03 movies loads correctly', async ({ page }) => {
    await login(page);
  ...
  test('04 shows loads correctly', async ({ page }) => {
    await login(page);
  ...
  test('05 profiles loads correctly', async ({ page }) => {
    await login(page);
