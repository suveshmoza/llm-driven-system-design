...
test.describe('pinterest Smoke Tests', () => {
  ...
  test('03 home feed loads correctly', async ({ page }) => {
    await login(page);
    await page.goto('/');
  ...
  test('04 create pin loads correctly', async ({ page }) => {
    await login(page);
  ...
  test('05 profile alice loads correctly', async ({ page }) => {
    await login(page);
