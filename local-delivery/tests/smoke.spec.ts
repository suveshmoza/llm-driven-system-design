...
test.describe('local-delivery Smoke Tests', () => {
  ...
  test('03 cart loads correctly', async ({ page }) => {
    await login(page);
  ...
  test('04 orders loads correctly', async ({ page }) => {
    await login(page);
  ...
  test('05 driver loads correctly', async ({ page }) => {
    await login(page);
