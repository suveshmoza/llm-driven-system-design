...
test.describe('linkedin Smoke Tests', () => {
  ...
  test('02 feed loads correctly', async ({ page }) => {
    await login(page);
    await page.goto('/');
  ...
  test('03 jobs loads correctly', async ({ page }) => {
    await login(page);
  ...
  test('04 network loads correctly', async ({ page }) => {
    await login(page);
