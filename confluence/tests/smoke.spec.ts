...
async function login(page: Page) {
  ...
  await page.locator("input#username").first().fill('alice');
...
test.describe('confluence Smoke Tests', () => {
  ...
  test('03 space view loads correctly', async ({ page }) => {
    await login(page);
    await page.goto('/space/ENG');
    await page.waitForTimeout(1000);
