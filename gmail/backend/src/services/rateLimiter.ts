...
export const sendRateLimiter: RateLimitRequestHandler = createRateLimiter({
  keyPrefix: 'send',
  max: 50,
  windowMs: 60 * 60 * 1000,
  message: 'You have reached the send limit. Please wait before sending more emails.',
...
export const searchRateLimiter: RateLimitRequestHandler = createRateLimiter({
  keyPrefix: 'search',
  max: 60,
  windowMs: 60 * 1000,
